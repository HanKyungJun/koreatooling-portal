...
class Blocks:
    ...
    def __init__(self, pl):
        ...
        H(('HSS','L평','밑골수리','비코팅'),     r'^(HSS )?라핑 (평 )?(?:밑옆날|밑외경|밑날외경|밑골수리|밑날\+외경) 비코팅$')
        H(('HSS','L평','밑골수리','코팅'),       r'^(HSS )?라핑 (평 )?(?:밑옆날|밑외경|밑날외경|밑골수리|밑날\+외경) 코팅$')
        H(('HSS','L코너볼','밑골수리','비코팅'), r'HSS +라핑 BALL.*(?:밑옆날|밑외경|밑날외경|밑골수리|밑날\+외경) 비코팅')
        H(('HSS','L코너볼','밑골수리','코팅'),   r'HSS +라핑 BALL.*(?:밑옆날|밑외경|밑날외경|밑골수리|밑날\+외경) 코팅')
        ...
        V(('초경','평','밑옆날','코팅'),     r'초경 FLAT E/M (?:밑옆날|밑외경|밑날외경|밑골수리|밑날\+외경)')
        V(('초경','코너볼','밑옆날','코팅'), r'초경 BALL E/M, 코너R E/M (?:밑옆날|밑외경|밑날외경|밑골수리|밑날\+외경)')
        ...
        H(('HSS','평','밑옆날','비코팅'),   r'^HSS (?:밑옆날|밑외경|밑날외경|밑골수리|밑날\+외경) 비코팅$')
        H(('HSS','평','밑옆날','코팅'),     r'^HSS (?:밑옆날|밑외경|밑날외경|밑골수리|밑날\+외경) 코팅$')
        H(('HSS','코너볼','밑옆날','비코팅'), r'^HSS 코너R E/M, BALL E/M (?:밑옆날|밑외경|밑날외경|밑골수리|밑날\+외경) 비코팅$')
        H(('HSS','코너볼','밑옆날','코팅'),   r'HSS 코너R E/M, BALL E/M,\s+(?:밑옆날|밑외경|밑날외경|밑골수리|밑날\+외경) 코팅')

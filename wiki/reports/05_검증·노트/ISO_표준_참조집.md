...
- **우리 적용**: ~~휠 정격 Vmax 확인의 근거. 09 시트 §6 운영 영역 상한 검토 시 직접 인용~~
  - 🔴 **2026-09-09 정정 — 보유 휠에는 적용되지 않는다.** 적용범위가 *"does not apply to **super abrasive products** and coated abrasive products"* 로 **초지립을 명시적으로 제외**한다 [STD-EN12413] [실측 검증 — BSI 제품 페이지]. 보유 휠 5종은 **레진 본드 초지립**이므로 대상이 아니다. → **2-5B 로 대체**한다.
  - 적용 대상은 **보통(결합) 연삭재** — 사내에서 보통 숫돌을 쓰는 공정이 있다면 그 범위에서는 유효하다.
- **공식 링크**: ~~https://www.iso.org/standard/72906.html~~
  - ⚠️ **번호·링크 확인 필요 (2026-09-09)**: 본 문서는 `72906`, `sources.md` 는 `74698` 로 **서로 다른 링크**를 달고 있고 후자는 **404** 다. 검색으로도 ISO 판이 확인되지 않는다. 실재가 확인되는 것은 **EN 12413:2019(CEN)** 뿐. **ISO 판이 없다고 단정하지 않는다 — 확인 필요.**
- **보유 상태**: 미보유 (**Tier 1 → Tier 3 강등** — 초지립 비적용이므로 우선 구매 대상 아님)
- **국내 매칭**: KS B 5023 (연삭숫돌 안전성)이 유사 영역 다룸

---

### 2-5B. 초지립(다이아몬드·CBN) 안전 — 🔴 보유 휠 적용 표준 (2026-09-09 신설)

#### EN 13236:2019 — Safety requirements for superabrasive products

- **Tier**: **1 (최우선)** — 보유 휠 5종이 전부 이 범위다
- **연도**: 2019
- **스코프 요약**: 초지립(다이아몬드·CBN) 제품의 안전 요구사항. 속도 클래스·시험·표기.
- **우리 적용**: **보유 휠의 Vmax(최대사용주속도) 근거.** [[휠RPM-정책-검증-노트]] · [[tools/wheels/index]] · 휠 5종 페이지 §3.
- **공식 링크**: https://standards.iteh.ai/catalog/standards/cen/6a19df87-7a7c-4cbf-a4f3-283754950c60/en-13236-2019
- **보유 상태**: 미보유 — ⚠️ **본문 유료. 레진 초지립 속도 클래스 실수치 미확보(2026-09-09). 추정하지 않는다.**
- **연계 요건**: **oSa 제품 표기 요건** [STD-OSA-SUPER-MARK] 이 이 표준을 근거로 **최대사용주속도(m/s) 제품 표기**를 요구한다 — **다이아몬드 와이어만 예외**.
- **국내·일본 매칭**: ❌ **없음.** **JIS R 6241:2018 은 적용범위가 보통 연삭숫돌 전용이며 다이아몬드·CBN 을 다루지 않는다** [STD-JISR6241] [실측 검증 — 본문 직접 판독]. ⇒ 국내·일본 규격 계열 제조사에는 초지립 Vmax 표기 의무가 없다. **홍익다이아 라벨에 Vmax 가 없는 이유를 설명한다.**
...
| 휠 정격 Vmax (보유 휠 = 초지립) | **EN 13236:2019** + oSa 표기 요건 ⚠️ ~~ISO 12413:2019~~ 은 초지립 비적용 (2026-09-09 정정) |
...
| **EN 13236:2019** | 미보유 | — | — | — | **Tier 1 (신설 2026-09-09 — 보유 휠 적용 표준)** |
| ISO 12413:2019 | 미보유 | — | — | — | ~~Tier 1~~ → **Tier 3** (초지립 비적용, 번호 확인 필요) |
...
ISO 1, ISO 230-3, ISO 525, ISO 6104, **EN 13236**, ISO 16089, ISO 6103, ISO 4287

> 🔴 **2026-09-09 정정** — 종래 이 목록의 ~~ISO 12413~~ 을 **EN 13236:2019** 로 교체했다. 12413 은 적용범위가 **초지립을 제외**하므로 보유 휠(레진 초지립)에 쓸 수 없다 [STD-EN12413]. 12413 은 보통 숫돌을 쓰게 될 때를 대비한 **Tier 3** 으로 내린다. 상세: `decisions.md` 2026-09-09 (3).
